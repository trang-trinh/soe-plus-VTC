  ...
  axios
    .post(
      baseURL + "/api/Roles/GetDataProc",
      {
        str: encr(
          JSON.stringify({
            proc: "sys_roles_count",
            par: [{ par: "s", va: options.value.SearchText }],
          }),
          SecretKey,
          cryoptojs
        ).toString(),
...
const modules = ref([]);
const renderTreeNews = (data, id, name, title) => {
  let arrChils = [];
  let arrtreeChils = [];
  data
  ...
  axios
    ...
    .then((response) => {
      ...
      if (data.length > 0) {
        ...
        //renderTree(data);
        let obj = renderTreeNews(data, "module_id", "module_name", "module");
  ...
  <div class="main-layout flex-grow-1 p-2" v-if="store.getters.islogin">
    ...
    >
      ...
      >
        <template #body="md">
          <Checkbox
            v-model="md.data.status"
            :binary="true"
            @change="upstatusRole(md.data)"
          />
        </template>
      </Column>
      <Column
      ...
      <div class="grid formgrid m-2">
        <div class="field col-12 md:col-12">
          <label class="col-4 text-left"
            >Mã nhóm <span class="redsao">(*)</span></label
          >
          <InputText
            spellcheck="false"
        ...
        >
        <small
          v-if="v$.role_id.maxLength.$invalid && submitted"
          class="col-12 p-error"
        >
          <div class="field col-12 md:col-12">
            <label class="col-4 text-left"></label>
        ...
        <div class="field col-12 md:col-12">
          <label class="col-4 text-left"
            >Tên nhóm <span class="redsao">(*)</span></label
          >
          <InputText
            spellcheck="false"
            class="col-8 ip36"
        ...
        >
        <small
          v-if="v$.role_name.maxLength.$invalid && submitted"
          class="col-12 p-error"
        >
          <div class="field col-12 md:col-12">
            <label class="col-4 text-left"></label>
  ...
  >
    ...
    >
      ...
      >
        <template #body="md">
          <MultiSelect
            v-if="md.node.data.module_key && function_modules.filter(
