    ...
    if (rf) {
        ...
        axios
            .post(
                ...
                {
                    proc: "sys_organization_get_department",
                    par: [
                        { par: "organization_id", va: declare.value.declare_id },
                        { par: "pageno", va: options.value.pagenoP },
                        { par: "pagesize", va: options.value.pagesizeP },
                        { par: "search", va: options.value.SearchText },
                    ],
...
<template>
    <div>
                    ...
                    <div>
                            ...
                            <Toolbar>
                                <template #start>
                                    <span class="p-input-icon-left">
                                        ...
                                        <InputText v-model="options.search" @keyup="searchStamp" type="text"
                                            spellcheck="false" placeholder="Tìm kiếm đơn vị" />
                                    </span>
                                </template>
                                <template #end>
                                    <Button @click="openBasic('Thêm mới')" label="Thêm mới" icon="pi pi-plus"
                                        class="mr-2" />
                        ...
                        <div style="border-top:2px solid #dee2e6">
                            ...
                            <div class="w-full d-lang-table  mx-2">
                                <TreeTable :value="datalists" v-model:selectionKeys="selectedKey" 
                                @nodeSelect="onNodeSelect" @nodeUnselect="onNodeUnselect" :filters="filters"
                                :showGridlines="true" selectionMode="checkbox" filterMode="strict" class="p-treetable-sm"
                                :rows="20" :rowHover="true" responsiveLayout="scroll" :scrollable="true" 
                                scrollHeight="flex">
                                ...
                                <Column field="Logo" header="Logo"
                                    ...
                                    <template #body="md">
                                        <Avatar v-if="md.node.data.logo" :image="basedomainURL + md.node.data.logo"
                                            class="mr-2" size="large" />
                                    </template>
                                </Column>
                                <Column field="organization_id" header="Mã đơn vị"
                                    class="align-items-center justify-content-center text-center"
                                ...
                                <Column header="Chức năng" headerClass="text-center"
                                    ...
                                    <template #body="md">
                                        <Button type="button" icon="pi pi-plus-circle"
                                            ...
                                            style="margin-right: 0.5rem" v-tooltip.top="'Thêm phòng ban'"
                                            @click="addTreeDonvi(md.node)"></Button>
                                        <Button type="button" icon="pi pi-pencil" v-tooltip.top="'Chỉnh sửa'"
                                            class="p-button-rounded p-button-secondary p-button-outlined"
                                            style="margin-right: 0.5rem" @click="editDonvi(md.node.data)"></Button>
                    ...
                    <div class="d-lang-table-r">
                        <Toolbar class="w-full  ">
                            <template #start>
                                <span class="p-input-icon-left">
                                    <i class="pi pi-search" />
                                    <InputText v-model="options.SearchText" @keyup="searchPaycheck" type="text"
                                        spellcheck="false" placeholder="Tìm kiếm đầu mục" />
                                </span>
                            </template>
                            ...
                            <template #end>
                                ...
                                <Button @click="refreshStamp" class="mr-2 p-button-outlined p-button-secondary"
                        ...
                        <TreeTable :value="datalistsDetails" v-model:selectionKeys="selectedWarehouses"
                            :loading="options.loadingP" :filters="filters" :showGridlines="true" class="p-treetable-sm"
                            :paginator="true" :rows="options.pagesizeP" :rowHover="true" responsiveLayout="scroll"
                            :lazy="true" :scrollable="true" scrollHeight="flex" @page="onPageP($event)"
                            ...
                            <Column field="type_order" header="Loại sắp xếp"
                                class="align-items-center justify-content-center"
                                headerStyle="text-align:center;max-width:120px"
                                bodyStyle="text-align:center;max-width:120px" filterMatchMode="contains">
                                <template #body="md">
                            ...
                            <Column field="paycheck_unit" header="Đơn vị tính"
                                class="align-items-center justify-content-center"
                                headerStyle="text-align:center;max-width:120px"
                                bodyStyle="text-align:center;max-width:120px" filterMatchMode="contains">
                                <template #body="md">
                            ...
                            <Column field="status" header="Trạng thái" class="align-items-center justify-content-center"
                                headerStyle="text-align:center;max-width:130px"
                                bodyStyle="text-align:center;max-width:130px" filterMatchMode="contains">
                                <template #body="data">
                                    <Checkbox :disabled="
                                        !(
                            ...
                            <Column field="status" header="Chức năng"
                                class="align-items-center justify-content-center text-center"
                                ...
                                <template #body="data">
                                    <Button type="button" icon="pi pi-plus-circle"
                                        class="p-button-rounded p-button-secondary p-button-outlined"
                                        v-tooltip.top="'Thêm chỉ tiêu'" @click="addWarehouseChild(data.node.data)"></Button>
                                    <div v-if="
                                        store.state.user.is_super == true ||
                                        store.state.user.user_id == data.node.data.created_by ||
                                        (store.state.user.role_id == 'admin' &&
                                    ...
                                    ">
                                        ...
                                        <Button @click="delWarehouse(data.node.data, true)"
                                            class="p-button-rounded p-button-secondary p-button-outlined mx-1" type="button"
                                            icon="pi pi-trash" v-tooltip.top="'Xóa'"></Button>
                                    </div>
                                </template>
                            </Column>
                            <template #empty>
            ...
            <form>
                <div class="grid formgrid m-2">
                    ...
                    <div class="col-12 field md:col-12 flex align-items-center">
                        ...
                        <Dropdown v-model="declare.declare_type" :options="listDeclareType" optionLabel="name"
                            optionValue="code" placeholder="----- Chọn loại phiếu -----" class="sel-placeholder  col-9"
        ...
        <Dialog :header="headerDialogP" v-model:visible="displayBasicP" :style="{ width: '35vw' }" :closable="true"
            :modal="true">
            <form>
                <div class="grid formgrid m-2">
                    <div class="field col-12 md:col-12">
                        <label class="col-3 text-left p-0">Mã số <span v-if="paycheck.paycheck_type == 2"
                                class="redsao">(*)</span></label>
                        <InputText v-model="paycheck.paycheck_code" spellcheck="false" class="col-9 ip36 px-2" :class="{
                    ...
                    <div class="field col-12 md:col-12">
                        ...
                        <InputText v-model="paycheck.paycheck_name" spellcheck="false" class="col-9 ip36 px-2" :class="{
                    ...
                    <div class="col-12 md:col-12 p-0" v-if="paycheck.paycheck_type == 2">
                        <div class="field col-12 md:col-12 flex">
                            <div class="col-12 p-0 flex align-items-center">
                                ...
                                <TreeSelect class="col-9 p-0" @change="onChangeParent" v-model="selectCapcha"
                                    :options="treemodules" :showClear="true" placeholder="Chọn cấp cha "
                                    optionLabel="data.paycheck_name" optionValue="data.paycheck_id"
                    ...
                    <div class="col-12 field md:col-12 flex align-items-center">
                        <div class="  col-6 md:col-6 p-0 align-items-center flex">
                            ...
                            <Dropdown v-model="paycheck.paycheck_type" :options="listPaycheckType" optionLabel="name"
                                optionValue="code" class="sel-placeholder  col-6" panelClass="d-design-dropdown" />
                        </div>
                        <div class="  col-6 md:col-6 p-0 align-items-center flex">
