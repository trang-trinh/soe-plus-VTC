    ...
    axios
        .post(
            baseURL + "/api/hrm/callProc",
            {
                str: encr(
                    JSON.stringify({
                        proc: "hrm_report_before_working_process_list1",
                        par: [
    ...
    <div class="main-layout true flex-grow-1 p-2 pb-0 pr-0">
      <div style="background-color: #fff; padding: 1rem;padding-left: 0;">
        <div class="bg-white format-center py-1 font-bold text-xl">
          BÁO CÁO QUÁ TRÌNH CÔNG TÁC CỦA NHÂN SỰ TRƯỚC KHI VÀO CÔNG TY<span v-if="options.totalRecords != null">&nbsp({{ options.totalRecords }})</span>
        </div>
      ...
      <div style="overflow: scroll;max-height: calc(100vh - 147px);min-height: calc(100vh - 147px);background-color: #fff;">
          ...
          <thead style="position: sticky; z-index: 6; top:0">
              ...
              <th class="text-center left-sticky1 left-1" rowspan="2" width="50">STT</th>
                <th class="text-center left-sticky1 left-2" colspan="3">NHÂN VIÊN</th>
                <th class="text-center" colspan="15">BÁO CÁO QUÁ TRÌNH CÔNG TÁC</th>
              </tr>
              <tr>
                  ...
                  <th class="text-center left-sticky1 left-4" width="200">Đơn vị/ Phòng ban</th>
                  <th class="text-center" width="200">Đơn vị làm việc</th>
                  <th class="text-center" width="200">Địa chỉ</th>
                  <th class="text-center" width="100">Ngày bắt đầu</th>
                  <th class="text-center" width="100">Ngày kết thúc</th>
                  <th class="text-center" width="120">Chức danh/ Ngạch</th>
                  <th class="text-center" width="120">Vị trí/ Chức vụ</th>
                  <th class="text-center" width="250">Mô tả</th>
                  <th class="text-center" width="150">Lý do nghỉ việc</th>
                  <th class="text-center" width="100">Mức thu nhập</th>
                  <th class="text-center" width="100">Người tham chiếu</th>
                  <th class="text-center" width="100">SĐT người tham chiếu</th>
              </tr>
          </thead>
