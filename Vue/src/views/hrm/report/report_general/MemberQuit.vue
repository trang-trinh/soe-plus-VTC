    ...
    <div style="overflow: scroll;max-height: calc(100vh - 124px);min-height: calc(100vh - 124px);background-color: #fff;">
        ...
        <tbody v-for="(bc, index1) in datalists" :key="index1">
            ...
            <tr v-for="(dg, index2) in bc.list_ns" :key="index2" class="item-hover">
                ...
                <td align="center" class="bg-aliceblue " @click="activeRow(dg)">      
                    {{dg.birthday}}
                </td>
                <td align="center" @click="activeRow(dg)" >{{dg.gender}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.identity_papers_code}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.identity_date_issue}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.identity_name_issue}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.personel_groups_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.position_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.title_name}}</td>
                <td align="center" @click="activeRow(dg)" ></td>
                <td align="center" @click="activeRow(dg)" ></td>
                ...
                <td align="center" @click="activeRow(dg)" >{{dg.type_contract_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.contract_code}}</td>
                <td align="center" @click="activeRow(dg)" >
                ...
                <td align="center" @click="activeRow(dg)" >{{dg.cultural_level_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.specialization_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.university_name}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.tax_code}}</td>
                <td align="center" @click="activeRow(dg)" >{{dg.insurance_code}}</td>
                <td align="center" @click="activeRow(dg)" ></td>
                <td align="center" @click="activeRow(dg)" ></td>
                <td align="center" @click="activeRow(dg)" ></td>
                <td align="center" @click="activeRow(dg)" ></td>
