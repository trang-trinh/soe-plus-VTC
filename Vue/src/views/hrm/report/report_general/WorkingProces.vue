...
const exportExcel = () => {
  ...
  tab_text = tab_text+ "<table><td colspan='16' class='head2'>"+(department_name.value.toUpperCase() || store.getters.user.organization_name)+"</td></table>";
  ...
  tab_text =
      tab_text +'<table><td colspan="16" class="cstd" >DANH SÁCH THÂM NIÊN CÔNG TÁC</td >';
