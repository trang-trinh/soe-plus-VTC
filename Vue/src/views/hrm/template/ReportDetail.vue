  ...
  window.location.href.substring(
    window.location.href.lastIndexOf("orient-") + 7,
        ...
        onMounted(() => {
            ...
            initBaocao(     Number( idNewsLoaded.value));
        
            // try {
            //     debugger
            //     let qr=decodeURIComponent(router.params.id.replaceAll("==","%"));
            //     let obj = {};
            //     try{
...
<template>
    <div class="bg-white h-full">
        <DocComponent :isedit="true" v-if="report" :pars="pars" :report="report" :callbackFun="callbackFun"></DocComponent>
    </div>
</template>
