...
const tabs = ref([
  { id: 0, title: "tab 0", icon: "", total: 0 },
  { id: 1, title: "tab 1", icon: "", total: 0 },
  { id: 2, title: "tab 2", icon: "", total: 0 },
  { id: 3, title: "tab 3", icon: "", total: 0 },
  { id: 4, title: "tab 4", icon: "", total: 0 },
]);
const bgColor = ref([
  "#F8E69A",
  "#AFDFCF",
...
<template>
  <div class="surface-100 p-2" style="overflow: hidden">
    ...
    <div
      class="box-info grid formgrid m-0"
      :style="{
        overflowY: 'auto',
        minHeight: 'unset',
                      ...
                      <div class="w-full text-left">
                        ...
                        >
                          <div>
                            ...
                            <span v-if="slotProps.item.end_string"
                              >Đến: <b>{{ slotProps.item.end_string }}</b>
                            </span>
                          </div>
                        </Button>
                      </div>
                      ...
                      <div class="w-full text-left">
                        ...
                        <div class="form-group">
                          <label class="m-0">
                            Loại nhân sự:
                            <span>{{
                              slotProps.item.personel_groups_name
                            }}</span>
                          </label>
                        </div>
                        <div class="form-group">
                          <label class="m-0">
                            Cấp nhân sự:
                            <span>{{
                              slotProps.item.personnel_level_name
                            }}</span>
                          </label>
                        </div>
                        <div class="form-group">
          ...
          <div class="col-6 md:col-6">
            <div class="my-2">
              <div class="card mt-2">
                <div class="card-header">
                  <span
                    >Quá trình công tác(đơn vị cũ)/Kinh nghiệm làm việc</span
                  >
                </div>
              </div>
              <Timeline
                    ...
                    <template #content>
                      <div class="w-full text-left">
                        ...
                        <div class="form-group">
                          <label class="m-0">
                            Mức lương:
                            <span>{{ slotProps.item.wage_string }} đ</span>
                          </label>
                        </div>
                        <div class="form-group">
                          <label class="m-0">
