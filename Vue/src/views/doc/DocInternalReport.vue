...
const loadDataSQL = () => {
  ...
  axios
    .post(baseURL + "/api/SQL/Filter_doc_report_list_internal", dataTeo, config)
    .then((response) => {
...
const columns = ref([
  ...
  { field: "signer", header: "Người ký" },
  { field: "ldt,saodv", header: "Lãnh đạo, Đơn vị phối hợp" },
]);
...
const exportData = (method) => {
  ...
  axios
    .post(
      ...
      {
        excelname: "BÁO CÁO CÔNG VĂN NỘI BỘ",
        proc: "doc_report_list_internal_export",
        par: [
          { par: "pageno", va: options.value.pagenoExport - 1 },
    ...
    <div class="d-lang-table">
      ...
      >
                            ...
                            <div class="flex">
                              ...
                              >
                                <Chip
                                  :label="option.name"
                                  removable
                                  @remove="RemoveMul(1, option.code)"
                                />
                              </div>
                            </div>
                            <template
                            ...
                            <div class="flex">
                              ...
                              >
                                <Chip
                                  :label="option.name"
                                  removable
                                  @remove="RemoveMul(3, option.code)"
                                />
                              </div>
                            </div>
                            <template
                            ...
                            <div class="flex">
                              ...
                              >
                                <Chip
                                  :label="option.name"
                                  removable
                                  @remove="RemoveMul(4, option.code)"
                                />
                              </div>
                            </div>
                            <template
                            ...
                            <div class="flex">
                              ...
                              >
                                <Chip
                                  :label="option.name"
                                  removable
                                  @remove="RemoveMul(5, option.code)"
                                />
                              </div>
                            </div>
                            <template
        ...
        <Column
          ...
          class="align-items-center justify-content-center text-center"
          headerStyle="text-align:center;max-width:130px"
          bodyStyle="max-width:130px;  word-break:break-all"
          bodyClass="limit-line-1"
          :sortable="true"
        >
          <template #filter="{ filterModel }">
        ...
        <Column
          ...
          bodyStyle="text-align:center;max-width:150px;;max-height:60px; word-break:break-word"
          class="align-items-center justify-content-center text-center"
        ...
        >
          <template #body="data">
            <div v-if="data.data.file_path">
              <Button
                @click="showURLSCV(basedomainURL + data.data.file_path)"
                icon="pi pi-paperclip"
                v-tooltip.top="'File đính kèm'"
