...
const updateDepartmentUser = (data) => {
  ...
  dtitle.value =
    "Cập nhật người chủ trì phòng ban (" + data.organization_name + ")";
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <template #body="data">
          <AvatarGroup>
            <div
              v-for="(value, index) in data.node.data.Thanhviens"
              :key="index"
            >
              <div>
                <Avatar
        ...
        <template #body="md">
          <div v-if="md.node.data.organization_type == 1">
            <Button
              ...
              v-tooltip.top="'Cập nhật người chủ trì'"
              class="p-button-rounded p-button-secondary p-button-outlined"
              style="margin-right: 0.5rem"
              @click="updateDepartmentUser(md.node.data)"
            ></Button>
            <Button
              v-if="md.node.data.Thanhviens"
              type="button"
              icon="pi pi-trash"
    ...
    <ModalListUserDepartmentVue
      v-if="openModalDialog == true"
      :visible="openModalDialog"
      :id="IDepartment"
      :userdepartment_id="User_ID_Department"
      :header="dtitle"
    ></ModalListUserDepartmentVue>
  </div>
</template>
