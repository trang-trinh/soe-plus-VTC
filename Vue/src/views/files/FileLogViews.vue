...
const rowClass = (data) => {
  return data.is_folder ? "yellow" : "blue";
};
    ...
    >
      <template #header>
        <h3 class="module-title mt-0 ml-1 mb-2">
          <i class="pi pi-database"></i> Thống kê lượt xem và tải xuống
      ...
      >
        <template #body="{ data }">
          <span class="image-text">{{ data.file_name }}</span>
        </template>
      </Column> -->
      <Column field="file_name" header="Tên"></Column>
      <Column
        header="Loại"
        class="align-items-center justify-content-center text-center"
        headerStyle="text-align:center;max-width:150px"
      ...
      >
        <template #body="{ data }">
          {{ data.is_folder ? "Kho dữ liệu" : "Tài liệu" }}
        </template>
      </Column>
            <Column
        :sortable="false"
      ...
      >
        <template #body="{ data }">
          {{ data.count_view_file ? data.count_view_file : 0 }}
        </template>
      ...
      <Column
        field="count_download_file"
        header="Lượt tải xuống"
        class="align-items-center justify-content-center text-center"
        headerStyle="text-align:center;max-width:100px"
        bodyStyle="text-align:center;max-width:100px"
      >
        <template #body="{ data }">
          {{ data.count_download_file ? data.count_download_file : 0 }}
        </template>
      </Column>
      <template #empty>
        <div
