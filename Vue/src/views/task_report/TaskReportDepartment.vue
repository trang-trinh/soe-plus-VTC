...
const listTaskReportDepartment = ref();
...
const listDropdownStatus = ref([
    ...
    { value: 5, text: "Chờ đánh giá", bg_color: "#33c9dc", text_color: "#FFFFFF" },
...
const ExportData = () => {
    ...
    let data = [...listTaskReportDepartment.value];
    data = groupBy(data, "organization_name");
    var arrNew = [];
    for (let k in data) {
        var Group = [];
    ...
    htmltable += "<thead>";
    htmltable += "<tr><th colspan='15' style='font-size:16px;text-align:center;'>BÁO CÁO THỐNG KÊ TỔNG HỢP CÔNG VIỆC THEO PHÒNG BAN</th></tr></thead></table>";
    ...
    if (listColumExportNews.value.filter(x => x.value == 'task_name').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Tên công việc</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'project_name').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Thuộc dự án</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'Tennhom').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Nhóm công việc</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'Nguoigiaoviecs').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Người giao việc</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'Nguoithuchiens').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Người thực hiện</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'description').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Mô tả</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'target').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Mục tiêu</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'progress1').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Kết quả đạt được</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'start_date').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Ngày bắt đầu</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'end_date').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Ngày kết thúc</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'SoNgaygiahan').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Số ngày gia hạn</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'progress2').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Tiến độ</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'status_name').length > 0) {
        htmltable += "<th style='width: 150px;font-size:14px;text-align: center;'> Trạng thái</th>";
    }
    if (listColumExportNews.value.filter(x => x.value == 'Nguoitheodois').length > 0) {
    ...
    if (arrNew.length > 0) {
        arrNew.forEach(function (t, index) {
            ...
            t.Group.forEach(function (d, index) {
                ...
                if (listColumExportNews.value.filter(x => x.value == 'task_name').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.task_name != null ? d.task_name : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'project_name').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.project_name != null ? d.project_name : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'Tennhom').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.Tennhom != null ? d.Tennhom : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'Nguoigiaoviecs').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.Nguoigiaoviecs != null ? d.Nguoigiaoviecs : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'Nguoithuchiens').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.Nguoithuchiens != null ? d.Nguoithuchiens : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'description').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.description != null ? d.description : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'target').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.target != null ? d.target : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'progress1').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.progress != null ? d.progress : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'start_date').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.start_date != null ? moment(new Date(d.start_date)).format("DD/MM/YYYY") : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'end_date').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.end_date ? moment(new Date(d.end_date)).format("DD/MM/YYYY") : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'SoNgaygiahan').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.SoNgaygiahan != null ? d.SoNgaygiahan : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'progress2').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.progress != null ? d.progress : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'status_name').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;text-align:center;'>" + (d.status_name != null ? d.status_name : '') + "</td>";
                }
                if (listColumExportNews.value.filter(x => x.value == 'Nguoitheodois').length > 0) {
                    htmltable += "<td style='width: 150px;font-size:14px;'>" + (d.Nguoitheodois != null ? d.Nguoitheodois : '') + "</td>";
                }
                htmltable += "</tr>";
            });
        });
    ...
    var source = 'data:application/vnd.ms-word;charset=utf-8,' + encodeURIComponent(header + htmltable + footer);
    var fileDownload = document.createElement("a");
    document.body.appendChild(fileDownload);
    fileDownload.href = source;
    fileDownload.download = 'BC_DSCV_PhongBan.doc';
    fileDownload.click();
...
const listColumExports = ref([
    ...
    { value: 'Tennhom', text: 'Tên nhóm', STT: 3 },
    { value: 'Nguoigiaoviecs', text: 'Người giao việc', STT: 4 },
    { value: 'Nguoithuchiens', text: 'Người thực hiện', STT: 5 },
    { value: 'description', text: 'Mô tả', STT: 6 },
    { value: 'target', text: 'Mục tiêu', STT: 7 },
    { value: 'progress1', text: 'Kết quả đạt được', STT: 8 },
    { value: 'start_date', text: 'Ngày bắt đầu', STT: 9 },
    { value: 'end_date', text: 'Ngày kết thúc', STT: 10 },
    { value: 'SoNgaygiahan', text: 'Số ngày gia hạn', STT: 11 },
    { value: 'progress2', text: 'Tiến độ', STT: 12 },
    { value: 'status_name', text: 'Trạng thái', STT: 13 },
    { value: 'Nguoitheodois', text: 'Người theo dõi', STT: 14 },
])
...
const openExportXML = () => {
  ...
  axios
    .post(
      baseURL + "/api/task_origin/TaskDepartment_export_xml",
      listTaskReportDepartment.value,
      config,
    )
    .then((response) => {
...
const chooseColumExport = (col) => {
    ...
    listColumExportOrigins.value.splice(a, 1).sort((a, b) => (a.STT > b.STT) ? 1 : -1);
}
...
<template>
    <div v-if="store.getters.islogin" class="main-layout true flex-grow-1 p-2" id="task-report">
        <div class="flex justify-content-center align-items-center">
            <Toolbar class="w-full custoolbar">
                        ...
                        <ul style="padding: 0px; margin: 0px">
                            ...
                            <li class="p-menuitem">
                                <div class="field col-12 md:col-12" style="display: flex; flex-direction: column;">
                                    ...
                                    <Dropdown :filter="true" v-model="opition.filtergroup_id" panelClass="d-design-dropdown" selectionLimit="1"
                                        placeholder="Chọn nhóm cồng việc" :options="listDropdownTaskGroup"
                                        optionLabel="group_name" optionValue="group_id" spellcheck="false"
                                ...
                                <div class="field col-12 md:col-12"
                                    ...
                                    <div class="grid formgrid">
                                        <div class="field col-6 md:col-6">
                                            <Calendar inputId="icon" class="col-12 ip36 px-2" placeholder="dd/MM/yy"
                                                v-model="opition.sdate" :showIcon="true" />
                                        </div>
                                        <div class="field col-6 md:col-6">
                                            <Calendar inputId="icon" class="col-12 ip36 px-2" placeholder="dd/MM/yy"
                                                v-model="opition.edate" :showIcon="true" />
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="p-menuitem">
                                <div class="field col-12 md:col-12" style="display: flex; flex-direction: column;">
                                    ...
                                    <Dropdown :filter="true" v-model="opition.filterStatus"
                                        placeholder="Chọn trạng thái" panelClass="d-design-dropdown" selectionLimit="1" :options="listDropdownStatus"
                            ...
                            <li class="p-menuitem">
                                <div class="field col-12 md:col-12" style="display: flex; flex-direction: column;">
                                    <label>Vai trò</label>
                                    <Dropdown :filter="true" v-model="opition.IsType" panelClass="d-design-dropdown" placeholder="Chọn vai trò"
                ...
                " label="Hủy lọc" />
                    ...
                    <Menu id="task_export" :model="itemExportButs" ref="menuExportButs" :popup="true">
                        <template #item="{ item }">
                            <a @click="ChangeExportTask(item)">{{
                                item.label
                            }}</a>
                        </template>
                    </Menu>
        ...
        <DataTable :showGridlines="true" :paginator="true" :rows="opition.PageSize" @page="onPage($event)"
            ...
            <Column field="task_name" header="Tên công việc" headerStyle="min-height:3.125rem;min-width: 25rem;"
                bodyStyle="min-width: 25rem;"></Column>
            <Column field="project_name" class="align-items-center justify-content-center text-center"
                header="Thuộc dự án" headerStyle="min-height:3.125rem;min-width: 10rem;" bodyStyle="min-width: 10rem;">
            </Column>
            <Column field="Tennhom" class="align-items-center justify-content-center text-center"
                header="Nhóm công việc" headerStyle="min-height:3.125rem;min-width: 10rem;"
                bodyStyle="min-width: 10rem;">
            </Column>
            <Column header="Người giao việc" class="align-items-center justify-content-center text-center"
    ...
    -webkit-box-orient: vertical;">{{ data.data.Nguoithuchiens }}</span>
            ...
            <Column field="SoNgaygiahan" header="Số ngày gia hạn"
                class="align-items-center justify-content-center text-center"
                headerStyle="min-height:3.125rem;min-width: 10rem;" bodyStyle="min-width: 10rem;">
            </Column>
            <Column header="Tiến độ" class="align-items-center justify-content-center text-center"
                headerStyle="min-height:3.125rem;min-width: 10rem;" bodyStyle="min-width: 10rem;">
                <template #body="data">
                    <span>{{ data.data.progress }}</span>
                </template>
            </Column>
            <Column header="Trạng thái" class="align-items-center justify-content-center text-center"
                headerStyle="min-height:3.125rem;min-width: 10rem;" bodyStyle="min-width: 10rem;">
                <template #body="data">
            ...
            <template #groupheader="slotProps">
                <span class="image-text">{{ slotProps.data.organization_name }}</span>
            </template>
            <template #empty>
          ...
          " v-if="listTaskReportDepartment != null">
        ...
        <Dialog :header="headerDialogExportData" v-model:visible="DialogExportData" :closable="true" :maximizable="true"
            ...
            <form>
                <div class="grid formgrid m-2">
                    ...
                    <div class="field col-5 md:col-5 list-colum-exports"
                        style="border: 1px solid #aaa;min-height: calc(100vh - 360px) !important;max-height: calc(100vh - 360px) !important;overflow: hidden;">
                        <ul>
                    ...
                    <div class="field col-2 md:col-2">
                        <ul class="chucnang">
                            <li><i @click="chooseAllColum(true)" v-tooltip="'Chọn tất cả'"
                                    class="pi pi-angle-double-right"></i></li>
                            <li><i @click="chooseAllColum(false)" v-tooltip="'Bỏ chọn tất cả'"
                                    class="pi pi-angle-double-left"></i></li>
                        </ul>
                    </div>
                    <div class="field col-5 md:col-5 list-colum-exports"
                        style="border: 1px solid #aaa;min-height: calc(100vh - 360px) !important;max-height: calc(100vh - 360px) !important;overflow: hidden;">
                        <ul>
                            <li v-for="l in listColumExportNews" style="display: flex;">
                                <p style="flex: 1;margin: 0px;">{{ l.text }}</p>
                                <span @click="removeColumExport(l)" style="display: none;"><i
            ...
            <template #footer>
                ...
                <Button label="Xuất Word" icon="pi pi-file" @click="ExportData()" />
            </template>
        </Dialog>
    </div>
</template>
...
#task_report_filter ul {
    width: 100%;
    height: 500px;
    overflow-y: hidden;
}

#task_report_filter ul:hover {
