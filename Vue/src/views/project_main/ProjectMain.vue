                    ...
                    <template #start>
                        <span class="p-input-icon-left">
                            ...
                            <InputText type="text" spellcheck="false" v-model="opition.search"
                                placeholder="Tìm kiếm theo tên dự án" v-on:keyup.enter="loadData(true)" />
                        </span>
                    </template>

                    <template #end>
                        <Button label="Thêm dự án" icon="pi pi-plus" class="mr-2"
                            @click="addProjectMain('Thêm mới dự án')" />
                        <Button class="mr-2 p-button-outlined p-button-secondary" icon="pi pi-refresh"
                            @click="onRefersh" />
                        <Button label="Xoá" icon="pi pi-trash" class="mr-2 p-button-danger"
                            v-if="selectedNodes.length > 0" @click="DelProjectMain()" />
                ...
                <template #body="md">
                    ...
                    ">
                        <Button type="button" icon="pi pi-plus-circle"
                            ...
                            v-tooltip.top="'Thêm dự án'" @click="addTreeProjectMain(md.node.data)"></Button>
            ...
            <form>
                <div class="grid formgrid m-2">
                    <div class="field col-12 md:col-12">
                        ...
                        <InputText v-model="ProjectMain.project_code"
                            @change="removeVietnameseTones(ProjectMain.project_code)" spellcheck="false"
                            class="col-9 ip36 px-2" :class="{ 'p-invalid': v$.project_code.$invalid && submitted }" />
                    </div>
                    ...
                    <div class="field col-12 md:col-12 flex">
                        ...
                        <div class="col-9 p-0">
                            <div class="inputanh relative">
                                <img @click="chonanh('AnhDonvi')" id="LogoDonvi" style="height: 80px; width: 100px"
                                    v-bind:src="
                                        ProjectMain.logo
                                            ? basedomainURL + ProjectMain.logo
                                            : basedomainURL + '/Portals/Image/noimg.jpg'
                                    " />
                                <Button v-if="isDisplayAvt || ProjectMain.logo" style="width: 1.5rem; height: 1.5rem"
                                    icon="pi pi-times" @click="delLogo(ProjectMain)"
                    ...
                    <div class="field col-12 md:col-12" style="display: flex">
                        ...
                        <Textarea style="margin-top: 5px; padding: 5px" v-model="ProjectMain.description"
                    ...
                    <div class="field col-12 md:col-12">
                        ...
                        <Dropdown :filter="true" style="margin-top: 5px" v-model="ProjectMain.status"
                            :options="listDropdownStatus" optionLabel="text" optionValue="value"
                            placeholder="Trạng thái dự án" spellcheck="false" class="col-9 ip36 p-0">
                            <template #option="slotProps">
                    ...
                    <div class="field col-12 md:col-12">
                        ...
                        <InputNumber v-model="ProjectMain.is_order" style="padding: 0px !important"
