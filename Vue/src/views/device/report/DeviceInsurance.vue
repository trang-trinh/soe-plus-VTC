...
const filterCard = (check) => {
  ...
  isDynamicSQL.value = true;
  loadData(true);  filterButs.value.hide();
};
//Tìm kiếm
const searchCard = () => {
  loadData(true);
          ...
          <Toolbar class="d-toolbar p-0 py-3 surface-50">
            <template #start>
              <span class="p-input-icon-left">
                ...
                <Button
                  :class="
                    (filterCardUser != null || filterTrangthai != null) &&
                    checkFilter
                      ? ''
              ...
              >
                ...
                <Calendar v-tooltip.top="'Lọc theo tháng bảo hành'"  @date-select ="loadData(true)"    class="mx-2"    placeholder="Tháng bảo hành"   :showIcon="true" inputId="monthpicker" v-model="options.filterMonth" view="month" dateFormat="mm/yy"  />
            </template>
