...
const loadPhongban = (rf) => {
    axios
        ...
        .then((response) => {
            ...
            if (data[0] != null)
                loadDataDetails(data[0].organization_id);
        })
        .catch((error) => {
...
<template>
                            ...
                            <div class="w-full d-lang-table">
                                <TreeTable :value="donvis" v-model:selectionKeys="selectedKey" :paginator="true"
                                    ...
                                    <Column field="Logo" header="Logo"
                                        ...
                                        <template #body="md">
                                            <div @click="loadDataDetails(md.node.data.organization_id)">
    ...
    <Dialog header="Cập nhật Đơn vị/ Phòng ban" v-model:visible="displayAddDonvi" :style="{ width: '860px', zIndex: 2 }"
