<script setup>
  ...
  <template>
      ...
      <div v-if="isShowDialog" class="relative overflow-hidden" style="overflow-y: hidden !important">
      
  
        <div class="w-full format-center">
          <div>
            <h2 class="pt-0 mt-0 text-blue-700">
              Báo cáo công việc từ ngày
              {{ moment(new Date(dataTime[0])).format("DD/MM/YYYY") }} -
              {{
                moment(new Date(dataTime[dataTime.length - 1])).format(
                  "DD/MM/YYYY"
                )
              }}
            </h2>
            ...
            <div class="text-lg">
              ...
              <span class="text-900 cursor-pointer " :style=" clickFilter==0?'background-color:cyan;border-radius:5px':''" @click="onFilter(0)"
                >Kế hoạch </span
              >|<span @click="onFilter(1)"  :style=" clickFilter==1?'background-color:cyan;border-radius:5px':''" class="text-blue-600 cursor-pointer">
                Đang làm </span
              >|
              <span class="text-purple-600 cursor-pointer"  :style=" clickFilter==2?'background-color:cyan;border-radius:5px':''" @click="onFilter(2)">
                Đang Test </span
              >|
              <span
                class="text-green-600 line-through cursor-pointer"
                :style=" clickFilter==3?'background-color:cyan;border-radius:5px':''"
                @click="onFilter(3)"
              >
              Đã Test OK</span
              >
              |
              <span class="text-yellow-600 cursor-pointer"  
              :style=" clickFilter==4?'background-color:cyan;border-radius:5px':''"
              @click="onFilter(4)">
                Test chưa OK</span
              >
              |
              ...
              :style=" clickFilter==5?'background-color:cyan;border-radius:5px':''" @click="onFilter(6)">
              Phát sinh thêm</span
              >
              |
              <span  class=" text-yellow-600 cursor-pointer"
              :style=" clickFilter==6?'background-color:cyan;border-radius:5px':''" @click="onFilter(7)"
                >Tạm đóng</span
              >
                  ...
                  >
                    ...
                    >
                      <div
                        v-tooltip.top="
                          'Hoàn thành: ' +
                          moment(new Date(data.finished_date)).format(
                            'DD/MM/YYYY'
                          )
                        "
                      >
