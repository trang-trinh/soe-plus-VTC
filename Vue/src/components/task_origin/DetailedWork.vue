...
import DetailedChild from "./Detail_Task/DetailLoop.vue";
import ChildTask from "./Detail_Task/ChildTask.vue";
...
const EditTask = (task) => {
  is_Add.value = false;
  DialogData.value = task;
  headerAddTask.value = "Cập nhật thông tin";
  displayTask.value = true;
};
...
<template>
  <Sidebar
    ...
    :visible="visible"
    :style="
      PositionSideBar == 'full'
        ? {}
        : {
            width:
              props.turn > 0
                ? width1 > 1800
                  ? 'calc(65vw - ' + props.turn * 2 + 'rem)'
                  : 'calc(75vw - ' + props.turn * 2 + 'rem)'
                : width1 > 1800
                ? 'calc(65vw)'
                : 'calc(75vw)',
      ...
      >
        <div class="col-9 p-0 m-0">
                ...
                >
                  ...
                  <div class="row col-12">
                    ...
                    <div
                      ...
                      style="font-weight: 600; color: #888; font-size: 1.15rem"
                      v-if="
                        datalists.start_real_date || datalists.end_real_date
                      "
                    >
                      <div
                        class="col-6 p-0 m-0"
                  ...
                  >
                    ...
                    <div class="col-12 p-0 m-0">
                      <div class="col-12 p-0 m-0">
                        ...
                        >
                          <span
                            v-if="datalists.description.length > 1 && m != ''"
                            >- </span
                          >{{ m }}
                        </div>
                      </div>
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              v-tooltip="{
                                value: c.description,
                                disabled: c.description != null ? true : false,
                              }"
                            >
                          ...
                          >
                            <div class="col-12 p-0 m-0 pl-3">
                              ...
                              >
                                ...
                                >
                                  <div
                                    class="flex col-12 p-0 m-0 format-center"
                                  >
                                    <div class="col-10 p-0 m-0 format-center">
                                      ...
                                      <div
                                        class="col-10 p-0 m-0 format-default"
                                      >
                                        <Textarea
                                          rows="1"
                                          :autoResize="true"
                                ...
                                >
                                  ...
                                  >
                                    <div class="col-12 p-0 m-0">
                                      <Image
                                        :src="
                                          basedomainURL + slotProps.file_path
                                        "
                                        :alt="slotProps.file_name"
                                        preview
                          ...
                          >
                            <div class="col-12 p-0 m-0 pb-2">
                              ...
                              >
                                ...
                                >
                                  <i
                                    class="pi pi-link text-black text-4xl m-2"
                                  />
                                  Tệp đính kèm
                                </div>
                                <div class="col-1"></div>
          ...
          <div v-if="CongViecCon == true">
            <ChildTask
              :datalists="datalists"
              :addLinkTaskOrigin="addLinkTaskOrigin"
              :addNewChildTaskOrigin="addNewChildTaskOrigin"
              :isClose="isClose"
            ...
            <div :class="'col-12 format-right p-0 m-0 pt-2'">
              <AvatarGroup>
                ...
                <Avatar
                  ...
                  v-tooltip.left="{
                    value:
                      'và ' + (members.length - 4) + ' người khác tham gia',
                  }"
