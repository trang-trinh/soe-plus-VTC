...
<template>
    <div id="project-calendar"
        style="max-height: calc(100vh - 60px);min-height: calc(100vh - 60px);display: -webkit-box;overflow-x: auto;padding-top: 5px;overflow-y: hidden;"
        class="grid formgrid m-2">
        <div class="field col-12 md:col-12"
            style="display: flex;padding: 0px;max-height: calc(100vh - 60px);min-height: calc(100vh - 60px);flex-direction: column;">
...
" v-bind:image="basedomainURL + value.avatar" style="
                                        ...
                                        <Avatar v-if="l.Thanhviens.length - l.ThanhvienShows.length > 0" :label="
                                            '+' +
                            ...
                            <td class="no-fixcol-hover" style="background-color: #fff; border: 1px solid #e9e9e9" width="40"
                                ...
                                <div v-if="g.IsCheck" class="divbg" :style="
                                    'background-color:' +
                                    l.status_bg_color +
                                    '!important;color:' +
                                    l.status_text_color
