...
const onPage = (event) => {
  ...
  if (event.page == 0) {
    ...
    opition.value.id =
      listProjectMainChild.value[
        listProjectMainChild.value.length - 1
      ].project_id;
    opition.value.IsNext = true;
  } else if (event.page < opition.value.PageNo) {
    //Trang trước
        ...
        >
          <div style="position: absolute; top: 2px; right: 20px; z-index: 2">
            <AvatarGroup>
              ...
              <Avatar
                v-if="Thanhviens.length - ThanhvienShows.length > 0"
                :label="'+' + (Thanhviens.length - ThanhvienShows.length) + ''"
                class="cursor-pointer"
                shape="circle"
                style="
          ...
          <TabView
            ...
            style="height: 100%"
            v-model:activeIndex="active1"
          >
            <TabPanel header="Thông tin chung">
              <div
                class="tab-project-content h-full w-full col-md-12 p-0 m-0 flex"
              >
                <div class="col-6 p-0 m-0 tab-project-content-left">
                  <div class="row">
                    <div
                      ...
                      "
                    >
                      <i class="pi pi-chart-pie"></i> Thống kê chung
                    </div>
                    <div class="col-12">
                      <div class="row flex">
                          ...
                          <div class="row flex">
                            ...
                            >
                              <li
                                ...
                                :class="{ active: opition.type_chart == 1 }"
                              >
                                Công việc tham gia
                              </li>
                              <li
                                @click="ChangeTypeChart(2)"
                                :class="{ active: opition.type_chart == 2 }"
                              >
                                Công việc thực hiện
                              </li>
                              <li
                                @click="ChangeTypeChart(3)"
                                style="border-radius: 0px 5px 5px 0px"
                                :class="{ active: opition.type_chart == 3 }"
                              >
                                Công việc quản lý
                              </li>
                            </ul>
                  ...
                  <div class="row" style="padding: 15px; font-size: 13px">
                    <div class="col-12">
                      ...
                      <span style="font-weight: 600">{{
                        ProjectMainDetail.project_name
                      }}</span>
                    </div>
                    <div class="col-12">
                      Tạo bởi:
            ...
            <TabPanel header="Thảo luận">
              <Discuss :id="props.id"> </Discuss>
            </TabPanel>
            <TabPanel header="Lịch">
              <ProjectCalendar :id="props.id"> </ProjectCalendar>
            </TabPanel>
...
:deep(.p-tabview .p-tabview-nav-container) {
  width: 95% !important;
...
.p-splitbutton.p-button-success > .p-button {
  color: #ffffff;
  background: #689f38;
  border: 0px solid #689f38 !important;
}
