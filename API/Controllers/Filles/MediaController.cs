...
namespace Movie.Controllers
{
    public class MediaController : ApiController
    {
        ...
        static MediaController()
        {
            ...
            InitialDirectory = HttpContext.Current.Server.MapPath("~/");
...

        {
            ...
            try
            {
                f = Regex.Replace(f.Replace("\\", "/"), @"\.*/+", "/");
                var listPath = f.Split('/');
                var pathFile = "";
                ...
                var path_temp = InitialDirectory + pathFile;

                FileInfo fileInfo = new FileInfo(Path.Combine(path_temp));
