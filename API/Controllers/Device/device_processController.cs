                    ...
                    ContinueWith<HttpResponseMessage>(t =>
                    {
                        ...
                        if (device_Approved != null)
                        {
                            if (device_Approved.is_approved_by_department == false)
                            {
                                ...
                                var device_Approved_Count = db.device_approved_department_user.Where(s => s.approved_group_id == device_Approved.approved_group_id).ToArray();
                                if (device_Approved_Count.Length == 1)
                                {
                                    process.is_last = true;
                                }
                                if (device_Approved_Users != null)
                        ...
                        else
                        {
                            ...
                            foreach (var item in device_Approved_Users)
                            {
                                ...
                                {
                                    var rePair_FL = db.device_repair.Where(s => (s.device_repair_id == process.device_note_id)).FirstOrDefault();
                                    sh.contents = "Đã duyệt phiếu sửa chữa: " + rePair_FL.repair_number;
                                ...
                                {
                                    var inventory_FL = db.device_inventory_slip.Where(s => (s.inventory_slip_id == process.device_note_id)).FirstOrDefault();
                                    sh.contents = "Đã duyệt phiếu kiểm kê: " + inventory_FL.inventory_number;
                                ...
                                {
                                    var recall_FL = db.device_recall.Where(s => (s.device_recall_id == process.device_note_id)).FirstOrDefault();
                                    sh.contents = "Đã duyệt phiếu thu hồi: " + recall_FL.recall_number;
                        ...
                        if (device_Approved != null)
                        {
                            ...
                            if (device_Approved.approved_type == 3 && device_Approved.is_approved_by_department == false)
                            {
                                if (process.device_process_type == 1)
                                {
                                    ...
                                    if (check_add_next == true && check_class == true)
                                    {
                                        var device_Repair = db.device_repair.Where(s => s.device_repair_id == process.device_note_id).FirstOrDefault();
                                        if (device_Repair != null)
                                            device_Repair.status = 2;
                            ...
                            if (device_Approved.approved_type == 2 && device_Approved.is_approved_by_department == false)
                            {
                                if (process.device_process_type == 1)
                                {
                                    ...
                                    if ((device_Approved_Users.Length - 2) > 0)
                                    {
                                    ...
                                    if (device_Process_Check != null)
                                    {
                                        ...
                                        {
                                            if ((device_Approved_Users.Length - 1) >= 0)
                                                for (int i = 0; i < device_Approved_Users.Length - 1; i++)
                                                {
                                                    if (device_Process_Check.approved_user_id == device_Approved_Users[i].approved_user_id)
                                                    {
                                                        ...
                                                        sh.created_token_id = tid;
                                                        sh.created_ip = ip;
                                                        sh.contents = "Đã duyệt phiếu sửa chữa: " + repairFL.repair_number;
                                                        sh.is_type = 0;
                                ...
                                if (process.device_process_type == 2)
                                {
                                    ...
                                    if (device_Process_Check != null)
                                    {
                                        if (device_Process_Check.is_approved == true)
                                        {
                                            if (device_Approved_Users.Length > 1)
                                                for (int i = 0; i < device_Approved_Users.Length - 1; i++)
                                                {
                                                    if (device_Process_Check.approved_user_id == device_Approved_Users[i].approved_user_id)
                                                    {
                                                        ...
                                                        sh.created_token_id = tid;
                                                        sh.created_ip = ip;
                                                        sh.contents = "Đã duyệt phiếu kiểm kê: " + inventoryFL.inventory_number;
                                                        sh.is_type = 0;
                                        ...
                                        if (device_Process_Check.is_approved == true)
                                        {
                                            for (int i = 0; i < device_Approved_Users.Length - 1; i++)
                                            {
                                                if (device_Process_Check.approved_user_id == device_Approved_Users[i].approved_user_id)
                                                {
                                                    ...
                                                    sh.created_token_id = tid;
                                                    sh.created_ip = ip;
                                                    sh.contents = "Đã duyệt phiếu thu hồi: " + recallFL.recall_number;
                                                    sh.is_type = 0;
                        ...
                        if (!check_add_next)
                        {
                            ...
                            if (device_Approved_Pre != null)
                                {
                                    if (device_Approved_Pre.is_approved_by_department == false)
                                    {
                                        ...
                                        var device_Approved_Users_Count = db.device_approved_department_user.Where(s => s.approved_group_id == device_Approved_Pre.approved_group_id).ToArray();
                                        if (device_Approved_Users_Count.Length == 1)
                                        {
                                            device_Add.is_last = true;
                                        }
                            ...
                            else
                            {
                                ...
                                foreach (var item in device_Approved_Users)
                                {
                                    ...
                                    {
                                        var rePair_FL = db.device_repair.Where(s => (s.device_repair_id == process.device_note_id)).FirstOrDefault();
                                        sh.contents = "Duyệt duyệt phiếu sửa chữa: " + rePair_FL.repair_number;
                                    ...
                                    {
                                        var inventory_FL = db.device_inventory_slip.Where(s => (s.inventory_slip_id == process.device_note_id)).FirstOrDefault();
                                        sh.contents = "Duyệt duyệt phiếu kiểm kê: " + inventory_FL.inventory_number;
                    ...
                    ContinueWith<HttpResponseMessage>(t =>
                    {
                        ...
                        if (device_Approved != null)
                        {
                            ...
                            if (device_Approved.approved_type == 2 && device_Approved.is_approved_by_department == false)
                            {
                                ...
                                if (process.device_process_type == 2)
                                {
                                    var inventory_Slip = db.device_inventory_slip.Where(s => s.inventory_slip_id == process.device_note_id).FirstOrDefault();
                                    if (inventory_Slip != null)
                                        inventory_Slip.status = 4;
                                }
                                if (process.device_process_type == 3)
                                {
                                    var device_Recall = db.device_recall.Where(s => s.device_recall_id == process.device_note_id).FirstOrDefault();
