...
//                        var hrm_class_ss = "";
//                        hrm_class_ss = provider.FormData.GetValues("hrm_candidate_academic").SingleOrDefault();
...
//                        hrm_candidate_family = provider.FormData.GetValues("hrm_students").SingleOrDefault();
//                        List<hrm_candidate_family> hrm_Users_Trainings = JsonConvert.DeserializeObject<List<hrm_candidate_family>>(hrm_candidate_family);
//                        foreach (var item in hrm_Users_Trainings)
//                        {
//                            item.candidate_id = candidate.candidate_id;
