...
namespace API.Models
{
    ...
    public partial class hrm_rec_calendar
    {
        public int rec_calendar_id { get; set; }
        public Nullable<int> campaign_id { get; set; }
        public string rec_calendar_name { get; set; }
        public Nullable<System.DateTime> rec_calendar_date { get; set; }
        public Nullable<System.DateTime> rec_time_start { get; set; }
        public Nullable<System.DateTime> rec_time_end { get; set; }
        public string interviewers { get; set; }
        public Nullable<int> rec_calendar_room { get; set; }
