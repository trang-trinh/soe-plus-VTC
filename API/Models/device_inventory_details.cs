...
namespace API.Models
{
    ...
    public partial class device_inventory_details
    {
        ...
        public string user_use_id { get; set; }
        public Nullable<int> amount_before { get; set; }
        public Nullable<int> is_status { get; set; }
        public Nullable<int> amount_after { get; set; }
