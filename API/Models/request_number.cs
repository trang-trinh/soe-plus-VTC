...
namespace API.Models
{
    ...
    public partial class request_number
    {
        public string setting_number_id { get; set; }
        public int organization_id { get; set; }
        public string id_key { get; set; }
        public int is_order { get; set; }
        public string information_column { get; set; }
        public Nullable<int> number_of_characters { get; set; }
