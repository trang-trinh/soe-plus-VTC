...
namespace API.Models
{
    ...
    public partial class device_process_files
    {
        public int process_files_id { get; set; }
        public int device_process_id { get; set; }
        public string process_files_code { get; set; }
        public Nullable<int> process_files_type { get; set; }
        public string process_files_name { get; set; }
