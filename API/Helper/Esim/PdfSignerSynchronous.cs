...
namespace DEMO_FULL_CA_DOTNET_WEB.Models
{
    public class PdfSignerSynchronous
    {
        ...
        public const string FORMAT_TEXT_7 = "Ký bởi: {0} \r\nLý do: {2} \r\nĐịa điểm: {3}";
        public const string FORMAT_TEXT_8 = "Ký bởi: {0} \r\nLý do: {2}";
        public const string FORMAT_TEXT_9 = "Ký bởi: {0} \r\nĐịa điểm: {3}";
        public const string FORMAT_TEXT_10 = "Ký bởi: {0}";
        public const string FORMAT_TEXT_11 = "Lý do: {2} \r\nĐịa điểm: {3}";
        public const string FORMAT_TEXT_12 = "Lý do: {2}";
        public const string FORMAT_TEXT_13 = "Địa điểm: {3}";
